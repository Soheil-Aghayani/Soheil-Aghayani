<div align="center">
  ...
  <p><strong>Environmental Engineer · Sustainability Researcher · Software Builder</strong></p>
  <p>Research that becomes a system. Systems that feel human.</p>
...
```mermaid
flowchart LR
  A[Environmental questions] --> B[Lab evidence]
  B --> C[Models and analysis]
  C --> D[Useful software]
  D --> E[Clearer human decisions]

  style A fill:#0b2f36,stroke:#1ea7a1,color:#f5f1e9
  style B fill:#0b2f36,stroke:#1ea7a1,color:#f5f1e9
  style C fill:#10294b,stroke:#3b82f6,color:#f5f1e9
  style D fill:#10294b,stroke:#3b82f6,color:#f5f1e9
  style E fill:#4a2f12,stroke:#f2b84b,color:#fff8ea
```
